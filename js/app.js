...
let responsiveClose = document.querySelector('#responsiveClose')

headerMenu.addEventListener('click', function () {
    responsive.classList.add('responsiveActive')
})

responsiveClose.addEventListener('click', function () {
    responsive.classList.remove('responsiveActive')
})

let responsiveItem = document.querySelectorAll('.responsive-item');
let itemIcons = document.querySelector('#itemIcon');

responsiveItem.forEach(function (item) {
    item.addEventListener('click', function () {
        responsiveItem.forEach(function (el) {
            el.classList.remove('responsive-item-active');
            itemIcons.classList.remove('responsive-buton-iconactive')
        });
        item.classList.add('responsive-item-active');
        itemIcons.classList.add('responsive-buton-iconactive')
    });
});
